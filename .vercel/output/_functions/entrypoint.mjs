...
import { g as getActionQueryString, a as astroCalledServerError, A as ActionError, d as deserializeActionResult, b as ACTION_QUERY_PARAMS, c as appendForwardSlash } from './chunks/astro-designed-error-pages_tbZHjakm.mjs';
import 'piccolore';
import 'es-module-lexer';
import './chunks/astro/server_CVvs-ccK.mjs';
import 'clsx';
import { Resend } from 'resend';
import { d as defineAction } from './chunks/server_AJ6qHuxr.mjs';
...
const resend = new Resend("re_FH6VPEjE_8oAVgogsbmRdPzSJ1xnU2Yip");
const server = {
  send: defineAction({
    accept: "form",
    input: z.object({
